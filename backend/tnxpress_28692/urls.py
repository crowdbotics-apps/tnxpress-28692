"""tnxpress_28692 URL Configuration
...
admin.site.site_header = "tnxpress"
admin.site.site_title = "tnxpress Admin Portal"
admin.site.index_title = "tnxpress Admin"

# swagger
api_info = openapi.Info(
    title="tnxpress API",
    default_version="v1",
    description="API documentation for tnxpress App",
)
